...
public class EnvironmentState {
	...
	public agent_ABtask1.Environment.LocationState getLocationState(String location) {
		return this.state.get(location);
	}

	public void setLocationState(String location, agent_ABtask1.Environment.LocationState locationState) {
